...
def main():
    ...
    with open(filename, "w") as fo, contextlib.redirect_stdout(fo):
        ...
        comment ="""
            ...
            # deployment process.
            #
            # This is a workaround for the fact that there is currently no standardized way to packagedocumentation
            # and examples in Python as part of the package. A Python package is Python code, and that's it.
            #
            # The usual way to deal with this is to refer to external websites for documentation (such as
            # readthedocs.io) and to point to another place (e.g. github, gitlab) for downloading example scripts.
            #
            ...
            # 
            # These corresponding directories are given below as zipped, base64-encoded strings.
        """
